...
create table wishlist(name varChar(255) NOT NULL,
...
create table wish(name varChar(255) NOT NULL, description varChar(255), price INT, wishlist_id INT, role_id INT, user_id int,
